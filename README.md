...
* **Risk Warning**:The program works by modifying memory, which carries the risk of account suspension.
* Modifying memory carries the risk of account suspension.
...
* **风险提示**：
* 该程序通过修改内存实现功能。
* 本程序涉及修改内存，存在账号被封禁的风险。虽然目前看来开发者暂未执行相关限制，
* 且游戏当前无反作弊系统，但请用户自行承担所有风险。
